...
မြင်သာအောင် ပြရပါက တံမြက်စည်း လှည်းခိုင်းသည့်အခါ
အမေ့လိုမျိုး ဘေးကနေထိုင်ကြည့်ပြီး ဟိုလိုလှည်း သည်လိုလှည်းစသဖြင့် တစ်ခုမှမလွတ်စေရဘဲ ဘေးကနေ ထိန်းချုပ်ပြီး ခိုင်းတဲ့ပုံစံမျိုးကို Imperative ပုံစံလို့ ဆိုလိုတာပါ။ 

အမှိုက်လှည်းတဲ့အခါ လှည်းချင်သလို လှည်းခွင့်မပေးပဲ ဘယ်လိုမျိုး စနစ်တကျလှည်းရမယ်ဆိုတာမျိုး ထိုင်ပြောဖို့ကို ပိုအားသန်တာမျိုးပေါ့။
...
5. Procedural Programming  ---> data types မိတ်ဆက်
...
6. Procedural Programming  --->   usage of data types 
...
7. Procedural programming ( notations )
...
တစ်ခုရှိတာက တံမြက်စည်းကို ကျွန်တော်တို့ ကိုင်တွယ်ရမှာမဟုတ်ပဲ

ကိုင်ခိုင်းရမယ့် မိခင်နေရာမှာ သရုပ်ဆောင်ကြရမှာဖြစ်လို့ 

မိခင်က သားသမီးကို ဒီလိုတံမြက်စည်းဆိုရင် ဒီလက်နဲ့ ဒီလိုကိုင်ရမယ်ဆိုတာမျိုး ပြောဖို့ လိုအပ်သလိုမျိုး

ကျွန်တော်တို့ကလည်း ကွန်ပြူတာကို ဒီလို data အမျိုးအစားဆိုရင်  memory ( RAM ) ထဲမှာ ဒီလိုသိမ်းထားရမယ်ဆိုတာမျိုး ပြောပြ‌ပေးဖို့ လိုအပ်ပါတယ်။
...
ညာဘက်ကပ်ရပ် ပထမဆုံး တစ်ခုက တစ်ဆယ်တစ်ထပ်နဲ့စားထားတာဖြစ်ပြီး 

နှစ်ခုမြောက်ဆိုရင်တော့ တစ်ဆယ် နှစ်ထပ်နဲ့ စားထားတယ်လို့ ဆိုလိုတာဖြစ်ပါတယ်။   
0.03    --->   3 / 100
...
8.Procedural Programming ( creating built-in data types )
...
အနှစ်ချုပ်ရရင်တော့ တကူးတက မှတ်စရာဆိုလို့ quotes, [ ], ( ), { } ဒီလေးခုနဲ့ True, False, None  ဒါပဲ ရှိပါမယ်။
...
data types တွေကို  လက်တွေ့ ဖန်တီးတာတွေ 

မိမိလိုချင်တဲ့ data အမျိုးအစားဟုတ်/ မဟုတ် စစ်ဆေးတာတွေ
 
ရှိထားတဲ့ data ကို ကိုယ်လိုချင်တဲ့ data ရအောင် ပြောင်းလဲတာတွေ

စတာတွေကိုတော့ နောက်သင်ခန်းစာမှပဲ ထည့်ရေးပေးပါ့မယ်။ 
...
9. Procedural programming ( Callable Types )
...
10. Procedural programming ( naming rules )
...
3. ကိုယ်စားပြုအမည် အမျိုးအစားများ
...
0.1 ဆိုရင် ဆယ်ပုံတစ်ပုံဖြစ်ပါမယ်။
point ရဲ့ ညာဘက် တစ်ခုအကွာဟာ တစ်ဆယ်တစ်ထပ်နဲ့ စားထားတယ်လို့ အဓိပ္ပါယ်ရပါတယ်။

0.001 ကတော့ တစ်ထောင်ပုံတစ်ပုံဖြစ်ပါမယ်။
decimal point ရဲ့ညာဘက် သုံးခုမြောက်နေရာမှာရှိလို့ တစ်ဆယ်သုံးထပ်နဲ့ စားထားတယ်လို့ အဓိပ္ပါယ်ရပါတယ်။
...
2. Tab တစ်ခုမှာလည်း space လေးချက်စာ အကွာအဝေး ရှိရမယ်ဆိုတာမျိုး သတ်မှတ်ထားပါတယ်။

Tab တစ်ခုကိာ space နှစ်ခုစာ အကွာအဝေးကနေ ရှစ်ခုစာအထိ သတ်မှတ်နိုင်ပါတယ်။

font setting ထဲမှာ သတ်မှတ်လို့ ရပါတယ်။

computer အများစုကတော့ သုံးခုစာ အကွာအ‌ဝေးလို့ သတ်မှတ်ထားကြမယ် ထင်ပါတယ်။

Tab က ကွန်ပြူတာအလိုက် space လေးချက်စာ အကွာအဝေး ရှိ/မရှိ မသေချာနိုင်လို့ space ကိုပဲ လူတိုင်းသုံးကြပါတယ်။

Tab လည်း သုံးခွင့်ပေးထားတာပဲဆိုပြီး သုံးခဲ့ရင်တော့ မေတ္တာပို့ခံရပါလိမ့်မယ်။

################################################

3. program ရေးတဲ့အခါ ဖိုင်တစ်ခုထဲမှာ space နဲ့ tab ကို အတူတူရောပြီး ရေးထားခဲ့ရင် Python က ဘာသာမပြန်ပေးပါဘူး။

မရောထားရင်တော့ ဘာသာပြန်ပေးပါတယ်။

ဒါပေမယ့်လည်း အများနဲ့လုပ်ကြရတဲ့အခါ

ကိုယ်က Tab နဲ့ ရေးထားပြီး တစ်ခြားသူရဲ့ space သုံးထားတဲ့ code တွေကို ကိုယ့်ဖိုင်ထဲကို copy ကူးပြီး ကြားညှပ်တာမျိုးဆိုရင် ဘာသာပြန်ပေးမှာ မဟုတ်သလို 

ကိုယ့် program ကိုလည်း တစ်ခြားသူက ယူသုံးခဲ့မယ်ဆိုရင် Tab နေရာမှာ space ပြန်ထားပြီး ပြန်ရေးနေရမှာဖြစ်လို့ မေတ္တာပို့ခံရပါလိမ့်မယ်။

################################################

4. အခုပြောခဲ့တဲ့ space နဲ့ Tab မရောရဘူးဆိုတာက ကုတ်အစုအဝေး ဖန်တီးတာကိုပဲ ဆိုလိုတာ ဖြစ်ပါတယ်။

ကုတ်အစုအဝေး ဖန်တီးကြတဲ့အခါ ဖတ်ရလွယ်ဖို့အတွက် နေရာလပ်တွေ ထားရတဲ့အခါ space လေးချက်သုံးဖို့ တိုက်တွန်းတာမျိုး ဖြစ်ပါတယ်။
...
4. direct type casting / explicit type casting 
...
တစ်နဲ့ နှစ်ကို ပေါင်းမယ်ဆိုပါစို့။
...
ဒါပေမယ့် int နဲ့ float  ဆိုတဲ့ မတူညီတဲ့ အမျိုးအစားနှစ်ခုကို ပေါင်းလိုက်တာမဟုတ်ပဲ 

အားလုံးကို float ဖြစ်ပြီး တူသွားအောင် တတိယနည်းကို မိမိအစား Python က သုံးပေးသွားတယ်ဆိုတာမျိုး 

ကြားထဲက အဆင့်တွေကို မြင်နိုင်နေရပါမယ်။
...
အထက်ပါအတိုင်းး 1 + 2 * 3 ကို ဖြေရှင်းတဲ့အခါ
...
ဘယ်လိုသေးသလဲ ဥပမာပေးရရင် computer မှာ RAM 8 GB ရှိပါတယ်။

8 GB ဆိုတာက 8 Gigabyte ဖြစ်ပါတယ်။

အလွယ်မှတ်ရင် Giga ဆိုတာကို သန်းတစ်ထောင်လို့ မှတ်ထားနိုင်ပါတယ်။
...
မီးခလုတ်မှာ အပိတ်/ အဖွင့် နှစ်ခုထဲက တစ်ခုထားနိုင်သလိုမျိုး ယူဆနိုင်ပါတယ်။

################################################

မီးခလုတ်ဖွင့်ရင် လျှပ်စစ်စီးမှာဖြစ်ပြီး မီးသီးက မီးလင်းပါမယ်။

ပိတ်ရင်တော့ လျှပ်စီးပတ်လမ်း ပြတ်တောက်သွားပါမယ်။

################################################

လျှပ်စစ်စီးတာကို 1 လို့ ယူဆမယ်ဆိုရင် မီးခလုတ်နှစ်ခုကို ဖွင့်လိုက်ကြောင်း အမှတ်အသားလုပ်ဖို့ 11 လို့ ရေးနိုင်သလို 

လျှပ်စစ်မစီးတာကို 0 လို့ ယူဆမယ်ဆိုရင်လည်း မီးခလုတ်နှစ်ခုကို ပိတ်လိုက်ကြောင်း အမှတ်အသားလုပ်ဖို့အတွက် 00 လို့ ရေးနိုင်ပါတယ်။

ဒီလိုမျိုး အမှတ်အသားနှစ်ခုတည်းကို အသုံးပြုပြီး ‌ရေတွက်တာ / ဖော်ပြတာကို binary numbering system လို့ ခေါ်ပြီး ပါဝင်တဲ့ နံပါတ်နှစ်ခုကိုတော့ binary digit လို့ ခေါ်ပါတယ်။

################################################

binary ရဲ့ အစနှစ်လုံးနဲ့ digit နဲ့ နောက်ဆုံးတစ်ခုကို ပေါင်းပြီး bit လို့ ခေါ်ကြပါတယ်။

ဒါကြောင့် bit ဟာ binary digit ရဲ့ အတိုကောက်ဖြစ်ပါတယ်။
...
Python မှာ ကိန်းဂဏန်းတွေနဲ့ ပတ်သတ်တဲ့ လုပ်ဆောင်ချက်တွေအတွက် arithmetic operator တွေကို ဖန်တီးထားသလို 

Bit နဲ့ပတ်သတ်တဲ့ လုပ်ဆောင်ချက်တွေအတွက်လည်း bitwise operator တွေကို ဖန်တီးပေးထားပါတယ်။
...
မြင်သာအောင် ပြောရရင် ကွန်ပြူတာဖွင့်တဲ့ program ဟာ p0 ဖြစ်ပြီး သီချင်းဖွင့်တဲ့ program ဟာ p1 ဖြစ်တယ်ဆိုပါစို့။
